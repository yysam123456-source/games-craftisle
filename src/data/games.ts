...
export const games: Game[] = [
  ...
  // ===== Messenger - 3D Planet Delivery Game (original by abeto) =====
  {
    id: "messenger",
    slug: "messenger",
    title: "Messenger",
    description: "A tiny planet, but someone's gotta make the deliveries! Explore a beautiful low-poly 3D world, interact with characters, and experience a charming delivery adventure.",
    category: "casual",
    tags: ["3d", "adventure", "three.js", "low-poly", "planet", "story-driven"],
    source: "embed",
    sourceUrl: "https://messenger.abeto.co/",
    thumbnail: "/games/messenger/thumbnail.svg",
    backgroundImage: "/games/messenger/thumbnail.svg",
    instructions: "Click/Tap to interact with the world. Use mouse or touch to explore.",
    controls: { keyboard: false, mouse: true, touch: true, gamepad: false },
    isOriginal: false,
    isActive: true,
    playCount: 0,
